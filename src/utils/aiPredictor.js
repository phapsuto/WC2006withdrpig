 ...
 */
export function getTeamRecentForm(teamName, matches = []) {
 ...
 */
export function predictMatch(homeTeamName, awayTeamName, currentHomeScore = 0, currentAwayScore = 0, status = 'UPCOMING', minute = 0, matches = [], bookmakerOdds = null) {
